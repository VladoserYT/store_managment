"""
Модуль gui.py - Графический интерфейс на Tkinter.

Этот модуль предоставляет полнофункциональный GUI для:
- Управления товарами (добавление, редактирование, удаление)
- Управления клиентами (регистрация, просмотр, редактирование)
- Создания и управления заказами
- Просмотра и фильтрации данных
...
class OnlineStoreApp:
    """
    Главное приложение интернет-магазина.
    
    Демонстрирует работу с Tkinter для создания GUI.
    """
